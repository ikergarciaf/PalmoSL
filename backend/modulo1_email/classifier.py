"""Clasificacion de emails con Claude y fallback mock."""
...
class EmailClassifier:
    ...
    def classify(self, email: EmailMessage) -> EmailClassification:
        """Clasifica un email mediante Claude o heuristicas mock."""
        ...
        try:
            ...
            logger.exception("Claude fallo durante clasificacion; usando fallback mock")
            return self._mock_classify(email)
    ...
    def _mock_classify(self, email: EmailMessage) -> EmailClassification:
        ...
        rules: list[tuple[str, str, float]] = [
            ...
            ("compatibilidad", r"compatible|compatibilidad|sirve|modelo|impresora", 0.9),
            ("precio", r"precio|presupuesto|tarifa|coste|neto", 0.9),
            ("stock", r"stock|disponibilidad|ten[eé]is|unidades|reposici[oó]n", 0.9),
        ]
